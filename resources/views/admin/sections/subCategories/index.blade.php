                                            ...
                                            <table id="example2" class="table table-striped table-bordered pt-3">
                                                ...
                                                @foreach ($records as $record)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <form action="">
                                                                <a href="{{route('subSubCategories.index',['sub_category_id'=>$record->category->id])}}"
                                                                   target="_blank">
                                                                    {{$record->category['name_' . App::getlocale()]}}
                                                                </a>
                                                            </form>
                                                        ...
                                                        @if($record->category->is_brand)
                                                            <td>{{$record->category->brand->name ?? 'Unknown'}}</td>
                                                        @else
                                                            <td>{{'System'}}</td>
                                                        @endif
                                                        <td>
                                                        ...
                                                        <td>
                                                            <a href="{{route('subSubCategories.index',['sub_category_id'=>$record->id])}}"
                                                               target="_blank">view</a>
                                                        </td>

                                                        <td>
                                                            <a href="{{route('subCategories.edit',['subCategory'=>$record->id])}}"
                                                            ...
                                                            <form
                                                                action="{{route('subCategories.destroy',['subCategory'=>$record->id])}}"
