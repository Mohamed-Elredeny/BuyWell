                                            ...
                                            <table id="example2" class="table table-striped table-bordered pt-3">
                                                ...
                                                @foreach ($records as $record)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{route('collages.edit',['collage'=>$record->id])}}"
                                                               class="mr-3 text-muted" data-bs-toggle="tooltip"
                                                               data-bs-placement="top" title=""
                                                               data-bs-original-title="Edit">
                                                                <i class="mdi mdi-pencil font-size-18"></i>
                                                            </a>
                                                            <a href="{{route('collages.show',['collage'=>$record->id])}}"
                                                               class="mr-3 text-muted" data-bs-toggle="tooltip"
                                                               data-bs-placement="top" title=""
                                                            ...
                                                            <form
                                                                action="{{route('collages.destroy',['collage'=>$record->id])}}"
