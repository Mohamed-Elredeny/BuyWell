                                        ...
                                        <div class="table-responsive">
                                            <table id="example2" class="table table-striped table-bordered pt-3">
                                                ...
                                                @foreach ($records as $record)
                                                    <tr>
                                                        <td>{{$record->id}}</td>
                                                        <td>{{$record->SubCategory['name_' . App::getlocale()]}}</td>

                                                        <td>{{$record->name_ar}}</td>
                                                        <td>{{$record->name_en}}</td>
                                                        @if($record->SubCategory->category->is_brand)
                                                            <td>{{$record->SubCategory->category->brand->name ?? 'Unknown'}}</td>
                                                        @else
                                                            <td>{{'System'}}</td>
                                                        @endif
                                                        <td>
                                                        ...
                                                        <td>
                                                            <a href="{{route('subSubCategories.edit',['subSubCategory'=>$record->id])}}"
                                                            ...
                                                            <form
                                                                action="{{route('subSubCategories.destroy',['subSubCategory'=>$record->id])}}"
