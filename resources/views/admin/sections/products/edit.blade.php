                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                @if($record->model_type == 'category')
                                    Current Category: {{$record->category['name_ar']}}
                                @elseif($record->model_type == 'subcategory')
                                    Current Category: {{$record->subCategory->category['name_ar']}}
                                @else
                                    Current Category:
                                @endif
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                @if($record->model_type == 'subcategory')
                                    Current SubCategory: {{$record->subCategory['name_ar']}}
                                @else
                                    Current SubCategory:
                                @endif
                                ...
                                @foreach($images as $image)
                                    <div class="col-sm-4 text-center">
                                        ...
                                        <a class="btn btn-danger"
                                           href="{{route('deleteImage',['type'=>'products','id'=>$record->id,'index'=>$counter])}}">Delete</a>
                                    </div>
                                    <?php $counter++; ?>
                                @endforeach
                            @endif
