...
class CollagesController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($object->original['status']) {
            ...
            return view('admin.sections.' . $this->collections . '.index', compact('records', 'brands', 'keys', 'categories'));
        }
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('admin.sections.' . $this->collections . '.create', compact('collections', 'brands', 'categories', 'products', 'brand'));
    }
    ...
    public function show($id)
    {
        ...
        if ($object->original['status']) {
            ...
            return view('admin.sections.' . $this->collections . '.show', compact('record'));
            return $record;
        } else {
            return redirect()->back()->withErrors($object->original['msg']);
        }
    ...
    public function edit(Request $request, $id)
    {
        ...
        if ($object->original['status']) {
            ...
            return view('admin.sections.' . $this->collections . '.edit', compact('record', 'collections', 'collection', 'products', 'brand', 'brands', 'categories','active_products_ids'));
        } else {
            return redirect()->back()->withErrors($object->original['msg']);
        }
